...
class Bot(API):
    ...
    def download_photos(self, medias, path='photos/', max_photos=10, description=False):
        return download_photos(self, medias, path=path, max_photos=max_photos, description=description)
